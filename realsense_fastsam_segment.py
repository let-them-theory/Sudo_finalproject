...
_MODEL_CANDIDATES = [
    _SCRIPT_DIR / "mini_project" / "models" / "proto.pt",
    Path.home() / "sudo_ws" / "src" / "sudo" / "mini_project" / "models" / "proto.pt",
    Path.home() / "Sudo_finalproject-main" / "proto.pt",
]
MODEL_PATH = str(next((p for p in _MODEL_CANDIDATES if p.is_file()), _MODEL_CANDIDATES[0]))
